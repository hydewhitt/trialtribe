...
class CorpoNotch_Pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corponotch_pro';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corponotch-pro' ), $i ),
...
// Initialize.
$corponotch_pro_footer_widgets = new CorpoNotch_Pro_Footer_Widgets();
