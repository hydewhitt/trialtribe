...
function corponotch_custom_header_title() {
	if ( is_home() && is_front_page() ) : 
		$title = 'Trial Tribe PLLC' ?>
		<h2><?php echo esc_html( $title ); ?></h2>
	<!-- Bail if it's a start your case flow -->
	<?php elseif ( is_page('Start Your Case') ): ?>
		<?php return; ?>
                ...
                <div class="custom-header-content">
					...
					<?php if(is_home()&& is_front_page()): ?>
						<div class="wp-block-buttons is-layout-flex">
							<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="http://localhost/trialtribe/?page_id=24">Start your case<br>(In under 30 seconds)</a></div>
						</div>
					<?php endif; ?>
